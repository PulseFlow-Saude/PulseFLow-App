...
import '../screens/health_history/oxygen_respiratory_history_screen.dart';
...
/// Duração das transições [Transition.cupertino] — um pouco abaixo de 0,5 s parece “seco”; ~0,5 s fica mais natural.
const Duration _kRouteTransition = Duration(milliseconds: 500);
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.OXYGEN_RESPIRATORY_HISTORY,
      page: () => const OxygenRespiratoryHistoryScreen(),
      transition: Transition.cupertino,
      transitionDuration: _kRouteTransition,
      curve: Curves.fastOutSlowIn,
    ),
